...
# Using Dataset with 8 Classes (2688 Images)
...
img_indx = input('Enter a query image [0 to 2687]: ')

desc = ''
desc_file = 'descriptions_2_5k/description_' + str(img_indx) + '.txt'
...
parse_file = 'parsed_outputs_2_5k/parsed_output_' + str(img_indx) + '.txt'
...
classes = list()
tmp = 0
with open('classes_list_2_5k.txt', 'r') as f:
	for line in f.readlines():
...
dataset = list()
with open('dataset_double_2_5k.txt', 'r') as f:
	for line in f.readlines():

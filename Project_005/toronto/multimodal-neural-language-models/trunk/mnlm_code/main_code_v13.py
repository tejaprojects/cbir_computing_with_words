...
img_indx = input('Enter a query image [0 to 4484]: ')

desc = ''
desc_file = 'descriptions_4k/description_' + str(img_indx) + '.txt'
...
parse_file = 'parsed_outputs_4k/parsed_output_' + str(img_indx) + '.txt'
...
parsed_out_dir = './parsed_outputs_4k/'
...
classes = list()
tmp = 0
with open('classes_list_4k.txt', 'r') as f:
	for line in f.readlines():
...
dataset = list()
with open('dataset_double_4k.txt', 'r') as f:
	for line in f.readlines():
